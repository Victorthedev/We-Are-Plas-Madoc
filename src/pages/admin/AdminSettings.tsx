      ...
      <div className="space-y-6 max-w-2xl">
        ...
        <Card className="rounded-2xl border-admin-border">
          <CardContent className="p-6 space-y-4">
            ...
            <Button onClick={saveProfile} disabled={savingProfile} className="rounded-full bg-primary text-primary-foreground">
        ...
        <Card className="rounded-2xl border-admin-border">
          <CardContent className="p-6 space-y-4">
            ...
            <Button onClick={changePassword} disabled={savingPw} variant="outline" className="rounded-full border-primary/20 text-primary">
          ...
          <PermissionGuard roles={["super_admin"]}>
            <Card className="rounded-2xl border-admin-border">
              <CardContent className="p-6 space-y-4">
                ...
                <Button onClick={saveSettings} disabled={savingSettings} className="rounded-full bg-primary text-primary-foreground">
