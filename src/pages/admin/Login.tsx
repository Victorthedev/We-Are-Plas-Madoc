...
export default function AdminLogin() {
  ...
  if (loading) return <div className="font-admin min-h-screen bg-admin-surface flex items-center justify-center"><div className="w-8 h-8 border-4 border-primary border-t-transparent rounded-full animate-spin" /></div>;
  ...
  return (
    <div className="font-admin min-h-screen flex flex-col lg:flex-row">
      {/* Left - branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-admin-chrome relative items-center justify-center overflow-hidden">
        <DotPattern className="absolute inset-0 opacity-[0.08]" />
        <div className="relative z-10 text-center">
          <div className="w-20 h-20 rounded-full bg-primary mx-auto flex items-center justify-center text-white font-bold text-3xl mb-6">W</div>
