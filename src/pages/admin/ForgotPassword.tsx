...
export default function ForgotPassword() {
  ...
  return (
    <div className="font-admin min-h-screen flex">
          ...
          {sent ? (
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-green-100 mx-auto flex items-center justify-center mb-4">
                <EnvelopeIcon className="w-8 h-8 text-green-600" weight="duotone" />
              </div>
            ...
            <>
              ...
              <div className="text-center mt-4">
                <Link to="/admin/login" className="text-primary text-sm hover:underline">Back to login</Link>
              </div>
            </>
          )}
        </div>
