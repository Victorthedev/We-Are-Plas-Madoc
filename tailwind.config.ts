  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "wapm-deep": "hsl(var(--wapm-deep))",
        "wapm-dark": "hsl(var(--wapm-dark))",
        "wapm-cyan": "hsl(var(--wapm-cyan))",
      ...
      keyframes: {
        ...
        float: { "0%, 100%": { transform: "translateY(-12px)" }, "50%": { transform: "translateY(12px)" } },
        "fade-in-up": { from: { opacity: "0", transform: "translateY(30px)" }, to: { opacity: "1", transform: "translateY(0)" } },
        "bounce-down": { "0%, 100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(8px)" } },
      },
      animation: {
